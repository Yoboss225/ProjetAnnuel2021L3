...
public interface CalculetteListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CalculetteParser#codeif}.
	 * @param ctx the parse tree
	 */
	void enterCodeif(CalculetteParser.CodeifContext ctx);
	/**
	 * Exit a parse tree produced by {@link CalculetteParser#codeif}.
	 * @param ctx the parse tree
	 */
	void exitCodeif(CalculetteParser.CodeifContext ctx);
	/**
	 * Enter a parse tree produced by {@link CalculetteParser#codefor}.
	 * @param ctx the parse tree
	 */
	void enterCodefor(CalculetteParser.CodeforContext ctx);
	/**
	 * Exit a parse tree produced by {@link CalculetteParser#codefor}.
	 * @param ctx the parse tree
	 */
	void exitCodefor(CalculetteParser.CodeforContext ctx);
	/**
	 * Enter a parse tree produced by {@link CalculetteParser#coderepeat}.
	 * @param ctx the parse tree
	 */
	void enterCoderepeat(CalculetteParser.CoderepeatContext ctx);
	/**
	 * Exit a parse tree produced by {@link CalculetteParser#coderepeat}.
	 * @param ctx the parse tree
	 */
	void exitCoderepeat(CalculetteParser.CoderepeatContext ctx);
}