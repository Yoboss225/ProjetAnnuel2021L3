...
PREF_COR="/home/yoann-kb/Documents/L3INFO/SEMESTRE2/THEORIE_LANG/TPNote/benchmark/BMs"
...
# mon chemin antlr
ANTLR_JAR="/usr/local/lib/antlr-4.9.1-complete.jar"
# mon chemain MVàP
MVAP_JAR="/usr/local/lib/MVaP.jar"
...
do
   ...
   if ! /usr/bin/java -cp "$ANTLR_JAR":. org.antlr.v4.runtime.misc.TestRig ${filename%.*} $ENTRY < "$i" > $t_name.mvap 2> $t_name.comp.log
    then
