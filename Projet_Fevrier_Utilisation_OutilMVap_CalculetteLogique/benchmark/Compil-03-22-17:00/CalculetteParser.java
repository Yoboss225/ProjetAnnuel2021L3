...
public class CalculetteParser extends Parser {
	...
	public final CalculContext calcul() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << T__5) | (1L << T__6) | (1L << T__8) | (1L << T__9) | (1L << T__10) | (1L << T__22) | (1L << T__24) | (1L << T__26) | (1L << T__27) | (1L << NEWLINE) | (1L << FLOAT) | (1L << ENTIER) | (1L << RETURN) | (1L << IDENTIFIANT))) != 0)) {
				{
				{
				setState(67);
		...
		try {
			...
			case 1:
				...
				finInstruction();
				            ...
				            _localctx.code += "PUSHF " + (((DeclContext)_localctx).FLOAT!=null?((DeclContext)_localctx).FLOAT.getText():null) + "\n";
	...
	public final ArgsContext args() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << T__5) | (1L << FLOAT) | (1L << ENTIER) | (1L << IDENTIFIANT))) != 0)) {
				{
				setState(311);
